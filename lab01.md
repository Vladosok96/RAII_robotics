...
Если оба окна отобразились, знаачит все работает правильно!
...
[Шаблон программы перемещения и launch файл]: https://github.com/Vladosok96/RAII_robotics/tree/main/Samples/ex_01_turtlesim
